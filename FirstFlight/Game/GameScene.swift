...
final class GameScene: SKScene {
    ...
    // MARK: - Decorative Small Rocks (Generated in Code)

    private func generateDecorativeSmallRocks(
        totalCount: Int,
    ...
    private func makeDecorativeSmallRock(at position: CGPoint, variation: Int) -> SmallRock {
    ...
    private func findValidAnchoredPoint(
        ...
        let baseRadius = max(12, anchor.maxRadius * 0.75)
    ...
    private func findValidFreePoint(
        lakes: [LakeNode],
        placedPoints: [CGPoint]
    ) -> CGPoint? {
        let attempts = 80
